...
var modelName = "XYZ"; // initializing to the default value
var duration = 0; // initializing to the default value
...
function changeDuration() {
    ...
    let newDuration = parseInt(prompt("Enter the duration:"));
